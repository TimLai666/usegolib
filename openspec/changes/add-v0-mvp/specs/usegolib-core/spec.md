...
- Planned type bridge upgrades:
  - Level 2: add `map[string]T` where `T` is Level 1 or slice-of-Level-1.
  - Level 3: add struct/custom types (see `openspec/changes/add-v0-mvp/design.md`).
